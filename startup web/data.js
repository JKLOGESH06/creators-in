...
async function getProjects() {
    ...
    // Explicitly filter out the original sample projects by title to ensure they are removed from all views
    const sampleTitles = [
        "IoT Based Smart Agriculture System",
        "AI Based Plant Disease Detection",
        "Solar Powered Auto Charging Vehicle",
        "Smart Braking System",
        "E-Commerce Website with Payment Gateway",
        "Home Automation System via Bluetooth"
    ];
    
    return projects.filter(p => !sampleTitles.includes(p.title));
}
